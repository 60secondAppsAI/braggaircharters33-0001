						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="SeatNumber" type="text" placeholder="Enter SeatNumber" v-model="reservationToAdd.seatNumber"></base-input>
								  <base-input label="ReservationDate" type="text" placeholder="Enter ReservationDate" v-model="reservationToAdd.reservationDate"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Seat Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SeatNumber" type="text" placeholder="Enter SeatNumber" v-model="reservationDetails.seatNumber"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Reservation Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="reservationDetails.reservationDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
