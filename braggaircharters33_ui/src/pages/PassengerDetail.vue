						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="DateOfBirth" type="text" placeholder="Enter DateOfBirth" v-model="passengerToAdd.dateOfBirth"></base-input>
								  ...
								  <base-input label="ContactEmail" type="text" placeholder="Enter ContactEmail" v-model="passengerToAdd.contactEmail"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Last Name</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Date Of Birth</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="passengerDetails.dateOfBirth"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
															<tr> 
					...
					<td class="detail_view_column_2">Contact Email</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactEmail" type="text" placeholder="Enter ContactEmail" v-model="passengerDetails.contactEmail"></input>
																		</div>
						</td>
														</tr>
