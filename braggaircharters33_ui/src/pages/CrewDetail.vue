					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateCrew()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div id="app">
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Crews = true">Add</base-button>
								              <modal :show.sync="modal2Crews">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Crew Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CrewId" type="text" placeholder="Enter CrewId" v-model="crewDetails.crewId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">First Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FirstName" type="text" placeholder="Enter FirstName" v-model="crewDetails.firstName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Last Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="LastName" type="text" placeholder="Enter LastName" v-model="crewDetails.lastName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Role</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Role" type="text" placeholder="Enter Role" v-model="crewDetails.role"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateCrew() {
      ...
      const jsonData = JSON.stringify(this.crewDetails);
      const res = await CrewService.update(jsonData);
...
//        this.getAllCrews();
    ...
    async getCrewDetails() {
      try {
			let response = await CrewService.get(this.crewId);
			this.crewDetails = response.data;
