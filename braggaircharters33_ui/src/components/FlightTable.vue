    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'departureAirport',
          visible: true,
          scopedSlots: { customRender: 'departureAirport' },
          sorter: true
          //sorter: (a, b) => a.departureAirport - b.departureAirport,
		...
		dataIndex: 'arrivalAirport',
          visible: true,
          scopedSlots: { customRender: 'arrivalAirport' },
          sorter: true
          //sorter: (a, b) => a.arrivalAirport - b.arrivalAirport,
